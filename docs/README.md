...
mxIndustrial, the 2023 Industrial Forge Server. This is a modded Minecraft Server running Forge with Feed-The-Beast extensions for server management. We are running a primarily tech-themed modpack. A slowly-evolving Minecolonies Village at Spawn is planned.
...
Server pre-Launched on 1 July 2022
...
- [Delve into our Server Properties file](/server.properties)
...
### Get Minecraft
To run Minecraft on your computer, you will need Java version 8 and a Minecraft launcher:
- [Java SE 8 Runtime Environment](https://www.java.com/en/download/manual.jsp)
...
As of this writing, Microsoft will let you download both versions when you purchase a new account.
